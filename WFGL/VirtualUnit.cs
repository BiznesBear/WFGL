...
public static class Converts
{
    ...
    public static Pixel PushToPixel(this Point point) => new(point.X, point.Y);
    public static Pixel PushToPixel(this Size size) => new(size.Width, size.Height);
    ...
    public static Point PushToPoint(this Pixel pixel) => new(pixel.X, pixel.Y);
    public static Point PushToPoint(this Vector2 vector2) => new((int)vector2.X, (int)vector2.Y);

    public static Size PushToSize(this Pixel pixel) => new(pixel.X, pixel.Y);
